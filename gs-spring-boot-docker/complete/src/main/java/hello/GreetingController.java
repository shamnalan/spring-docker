...
public class GreetingController {
    ...
    public String greeting(@RequestParam(value="name", defaultValue="World") String name) {
		...
		String contents = "<tr><td><b>List NName</b></td><td><b>List Type</b></td><td><b>List Owner</b></td></tr>";
	    for (WatchList list : repository.findAll()) {
			//System.out.println(customer);
			//template = template + customer.firstName;
			contents = contents + "<tr><td>" + list.listName + 
					"</td><td>"+list.listType+"</td><td>"+list.listOwner+"</td></tr>";
		}
        ...
        /*return new Greeting(counter.incrementAndGet(),
                           // String.format(template, name), obj);
        					"", obj, dictionary);*/
        return "<table border='1'>"+contents+"</table><table><tr><td><a href='/createpage'>Create List</a></td></tr>"+
